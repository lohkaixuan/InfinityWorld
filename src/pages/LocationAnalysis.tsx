...
const LocationAnalysis: React.FC<LocationAnalysisProps> = ({
    ...
    useEffect(() => {
        const run = async () => {
            ...
            const realBusinesses = await findNearbyBusinesses(
                finalLoc,
                businessType
            );
                            ...
                            <div className="flex-1 overflow-y-auto">
                                {activeTab === "overview" ? (
                                    ...
                                    >
                                        ...
                                        />
                                        <LocationProfileChart
                                            data={analysis.locationProfile}
                                        />
                        ...
                        >
                            ...
                            <div className="flex-1 min-h-0 overflow-hidden">
                                {isGeocoding ? (
                                    ...
                                    <GoogleMap
                                        location={
                                            actualLocation || analysis.location
                                        }
